...
# CONFIGURATION
INPUT_FOLDER = "../engin_features_V4"
OUTPUT_FOLDER = "../walk_forward_results_V4"
MODELS_FOLDER = "../saved_models_V4"
...
def main():
    ...
    if not feature_files:
        print(f"\nCRITICAL ERROR: No feature files found in {INPUT_FOLDER}.")
        return

    print("\nLoading V4 Data into memory.")
    all_stocks = {}
    ...
    for fold_config in FOLDS:
        ...
        model_save_path = os.path.join(MODELS_FOLDER, f"Quant_Model_V4_Fold_{fold_num}.keras")
        ...
        if len(X_test_arr) > 0:
            ...
            results_df = pd.DataFrame({
                'Date': test_dates_global, 
                'Ticker': test_tickers_global, 
